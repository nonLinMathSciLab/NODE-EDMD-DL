...
def graph(x, y, name, type, correct=[], predict=[], phi_predict=[]):  # plt.xlim(1300,)
    ...
    if type == "plot":
        ...
        plt.legend()
        plt.tight_layout()
    plt.savefig("NODE_img/" + data_name + "_png/" + name + ".png")
    plt.savefig("NODE_img/" + data_name + "_eps/" + name + ".eps")
    #plt.show()
...
converge_plot("NODE", "exact", x_start_list, x2_start_list, x_lim_list)
converge_plot("NODE", "predicted", x_start_list, x2_start_list, x_exact_lim_list)
